...
class AddCourseModelFactory (private val repository: DataRepository?) : ViewModelProvider.Factory {
    ...
    companion object {
        fun createFactory(activity: Activity): AddCourseModelFactory {
            val context = activity.applicationContext
                ?: throw IllegalStateException("Not yet attached to Application")

            return AddCourseModelFactory(DataRepository.getInstance(context))
        }
    }
}